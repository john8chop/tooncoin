...
"""Verify that starting tooncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tooncoin with -h for help text")
        ...
        self.log.info("Start tooncoin with -version for version information")
        ...
        self.log.info("Start tooncoind with -fakearg to make sure it does not start")
