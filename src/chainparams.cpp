...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 0.5 * 24 * 60 * 60; // 3.5 days
       ...
       // vSeeds.emplace_back("seed-a.tooncoin.loshan.co.uk");
       // vSeeds.emplace_back("dnsseed.thrasher.io");
       // vSeeds.emplace_back("dnsseed.tooncointools.com");
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.tooncointools.com");
        //vSeeds.emplace_back("seed-b.tooncoin.loshan.co.uk");
