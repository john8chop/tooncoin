...
const char * const BITCOIN_CONF_FILENAME = "tooncoin.conf";
const char * const BITCOIN_PID_FILENAME = "tooncoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tooncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tooncoin";
#else
    // Unix
    return pathRet / ".tooncoin";
#endif
#endif
}
