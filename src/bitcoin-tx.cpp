...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tooncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tooncoin-tx [options] <hex-tx> [commands]  Update hex-encoded tooncoin transaction\n" +
            "or:     tooncoin-tx [options] -create [commands]   Create hex-encoded tooncoin transaction\n" +
            "\n";
