# Support for Output Descriptors in Tooncoin Core

Since Tooncoin Core v0.17, there is support for Output Descriptors in the
...
on Tooncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tooncoin Core wallets, a convenience function `combo` is
