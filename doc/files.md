...
* tooncoin.conf: contains configuration settings for tooncoind or tooncoin-qt
* tooncoind.pid: stores the process id of tooncoind while running
...
* debug.log: contains debug information and general logging generated by tooncoind or tooncoin-qt
